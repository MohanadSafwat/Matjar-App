                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Padding(
                                          ...
                                          child: Image.network(snapshot.data.data()['cartItems'][index]['itemUrl']),
                                        ),
                                  SizedBox(width:20 ,),
                                    ...
                                    children: <Widget>[
                                      Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              Text(
                                                snapshot.data.data()['cartItems'][index]['itemName'],
                                                style: TextStyle(
                                                    fontSize: 20,
                                                    fontWeight: FontWeight.bold),
                                              ),
                                              Text(
                                                snapshot.data.data()['cartItems'][index]['itemCategoryName'],
                                                style: TextStyle(
                                                    fontSize: 13,
                                                    fontWeight: FontWeight.bold),
                                              ),
